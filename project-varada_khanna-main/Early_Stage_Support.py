...
def plot_survival_curves_and_histograms(sim_outcomes_mono, sim_outcomes_combo):
    ...
    # Extract survival curves from PrevalencePathBatchUpdate object
    survival_curves = [
        sim_outcomes_mono.nLivingPatients,
        sim_outcomes_combo.nLivingPatients
    ]
    # Plot normalized survival curves
    path.plot_sample_paths(
        sample_paths= survival_curves,
        title='Normalized Survival curve Early Stage Cancer',
        x_label='Simulation time step (year)',
        y_label='Proportion of alive patients',
        legends=['MONO', 'COMBO'],
        color_codes=['blue', 'green'],
        file_name='figs/Early_Stage_survival_curves.png',
    ...
    # path.plot_sample_paths(
    #     sample_paths=survival_curves,
    #     title='Survival curve Early Stage Cancer',
    #     x_label='Simulation time step (year)',
    ...
    hist.plot_histograms(
        ...
        title='Histogram of patient survival time Early Stage Cancer',
        ...
        color_codes=['blue', 'green'],
        transparency=0.5,
        file_name='figs/Early_Stage_survival_times.png'
    )
...
def report_CEA_CBA(sim_outcomes_mono, sim_outcomes_combo):
    ...
    CEA.plot_CE_plane(
        title='Cost-Effectiveness Analysis for COMBO and MONO therapy for Early Stage',
        ...
        file_name='figs/Early_Stage_cea.png'
    )
    ...
    CEA.build_CE_table(
        ...
        effect_digits=2,
        icer_digits=2,
        file_name='CETable(Early_Stage).csv')
    ...
    CBA.plot_marginal_nmb_lines(
        title='Cost-Benefit Analysis for COMBO and MONO therapy for Early Stage',
        x_label='Willingness-to-pay per QALY ($)',
        y_label='Marginal Net Monetary Benefit ($)',
        interval_type='c',
        show_legend=True,
        figure_size=(6, 5),
        file_name='figs/Early_Stage_nmb.png'
    )
